...
public class IndexCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        Set<String> remoteNoteIds = notes.stream().map(NoteDetailResponse::id).collect(Collectors.toSet());
        ...
        while (true) {
            try {
                ...
                if (e.getResponse().getStatus() == 429 && retries < MAX_RETRIES) {
                    ...
                    logger.warn("Rate limited when fetching note %s. Retry %d/%d after %dms."
