...
public interface HackMdApi {
  ...
  Set<Note> getNotes(@HeaderParam("Authorization") String authorization);

  @POST
  @Path("/notes")
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  Note createNote(@HeaderParam("Authorization") String authorization, CreateNoteRequest request);

  @GET
  @Path("/notes/{noteId}")
  @Produces(MediaType.APPLICATION_JSON)
  Note getNote(@HeaderParam("Authorization") String authorization,
